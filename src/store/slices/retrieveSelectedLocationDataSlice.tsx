...
export const SelectedLocationDataSlice = createSlice({
  name: 'formInfoEdit',
  initialState,
  reducers: {
    retrieveSelectedLocationData: (state, action) => {
      state.locationClicked = action.payload.locationClicked;
      state.locationSaved = action.payload.locationSaved;
    ...
    editSelectedLocation: (state, action) => {
      state.locationName = action.payload.locationName;
      state.locationType = action.payload.locationType;
      state.locationLatLang = {
        lat: action.payload.locationLat,
    ...
    resetSelectedLocationData: state => {
      state.locationClicked = true;
      state.locationSaved = false;
      state.locationName = '';
      state.locationType = 'business';
      state.locationLatLang = {
        lat: 0,
        lng: 0,
      };
...
} = SelectedLocationDataSlice.actions;

export default SelectedLocationDataSlice.reducer;
